...
class AppStringsMy {
  static Map<String, String> get strings => {
    ...
    // User Management
    AppStrings.userManagement: 'အသုံးပြုသူစီမံခန့်ခွဲမှု',
    AppStrings.addNewUser: 'အသုံးပြုသူအသစ်ထည့်ရန်',
    AppStrings.editUser: 'အသုံးပြုသူပြင်ဆင်ရန်',
    AppStrings.userManagementTitle: 'အသုံးပြုသူစီမံခန့်ခွဲမှု',
    AppStrings.addUser: 'အသုံးပြုသူထည့်ရန်',
    AppStrings.userRole: 'အသုံးပြုသူအခန်းကဏ္ဍ',
    AppStrings.fullName: 'အမည်အပြည့်စုံ',
    AppStrings.userPhone: 'ဖုန်းနံပါတ်',
    AppStrings.userEmail: 'အီးမေးလ်',
    AppStrings.isActive: 'သက်ဝင်လှုပ်ရှားနေသည်',
    AppStrings.confirmPassword: 'စကားဝှက်အတည်ပြု',
    AppStrings.role: 'အခန်းကဏ္ဍ',
    AppStrings.email: 'အီးမေးလ်',
    AppStrings.phoneNumber: 'ဖုန်းနံပါတ်',
    AppStrings.refresh: 'ပြန်လည်ခေါ်ဆိုရန်',
    AppStrings.activate: 'သက်ဝင်လှုပ်ရှားစေရန်',
    AppStrings.active: 'သက်ဝင်လှုပ်ရှားနေသည်',
    AppStrings.inactive: 'ရပ်ဆိုင်းနေသည်',
    AppStrings.activeUserDescription: 'အသုံးပြုသူကိုလှုပ်ရှားနိုင်သည်',
    AppStrings.enterUsername: 'အသုံးပြုသူအမည်ထည့်ပါ',
    AppStrings.enterFullName: 'အမည်အပြည့်စုံထည့်ပါ',
    AppStrings.enterEmail: 'အီးမေးလ်ထည့်ပါ',
    AppStrings.enterPhoneNumber: 'ဖုန်းနံပါတ်ထည့်ပါ',
    AppStrings.selectRole: 'အခန်းကဏ္ဍရွေးပါ',
    AppStrings.newPassword: 'စကားဝှက်အသစ်',
    AppStrings.enterNewPassword: 'စကားဝှက်အသစ်ထည့်ပါ',
    AppStrings.enterPassword: 'စကားဝှက်ထည့်ပါ',
    AppStrings.passwordRequired: 'စကားဝှက်လိုအပ်သည်',
    AppStrings.enterConfirmPassword: 'စကားဝှက်အတည်ပြုထည့်ပါ',
    AppStrings.users: 'အသုံးပြုသူများ',
    AppStrings.noUsersFound: 'အသုံးပြုသူများမရှိပါ',
    AppStrings.addFirstUser: 'ပထမအသုံးပြုသူထည့်ရန်',
    AppStrings.status: 'အခြေအနေ',
    AppStrings.actions: 'လုပ်ဆောင်ချက်များ',
    AppStrings.notProvided: 'မပါရှိပါ',
    AppStrings.deactivate: 'ရပ်ဆိုင်းရန်',
    AppStrings.deactivateUserConfirmation: 'ဤအသုံးပြုသူကို ရပ်ဆိုင်းမှာ သေချာပါသလား?',
    ...
    // Category Management
    AppStrings.categoryManagement: 'အမျိုးအစားစီမံခန့်ခွဲမှု',
    AppStrings.categoryName: 'အမျိုးအစားအမည်',
    AppStrings.enterCategoryName: 'အမျိုးအစားအမည်ထည့်ပါ',
    AppStrings.enterDescription: 'ဖော်ပြချက်ထည့်ပါ',
    AppStrings.categoryStatistics: 'အမျိုးအစားကိန်းဂဏန်းများ',
    AppStrings.totalCategories: 'စုစုပေါင်းအမျိုးအစားများ',
    AppStrings.categoriesWithProducts: 'ကုန်ပစ္စည်းများပါသောအမျိုးအစားများ',
    AppStrings.categories: 'အမျိုးအစားများ',
    AppStrings.searchCategories: 'အမျိုးအစားများရှာရန်',
    AppStrings.noCategoriesFound: 'အမျိုးအစားများမရှိပါ',
    AppStrings.addFirstCategory: 'ပထမအမျိုးအစားထည့်ရန်',
    AppStrings.products: 'ကုန်ပစ္စည်းများ',
    AppStrings.stock: 'စတော့',
    AppStrings.noDescription: 'ဖော်ပြချက်မရှိပါ',
    AppStrings.cannotDelete: 'ဖျက်၍မရပါ',
    AppStrings.deleteCategory: 'အမျိုးအစားဖျက်ရန်',
    AppStrings.deleteCategoryConfirmation: 'ဤအမျိုးအစားကိုဖျက်ပစ်မှာသေချာပါသလား?',
    AppStrings.editCategory: 'အမျိုးအစားပြင်ဆင်ရန်',
    AppStrings.addNewCategory: 'အမျိုးအစားအသစ်ထည့်ရန်',

    // Additional strings
    AppStrings.all: 'အားလုံး',
    AppStrings.inStock: 'စတော့ရှိ',
    AppStrings.lowStock: 'စတော့နည်း',
    AppStrings.outOfStock: 'စတော့မရှိ',
    AppStrings.newItem: 'အရာအသစ်',
    AppStrings.addFirstItem: 'ပထမအရာထည့်ရန်',
    AppStrings.showing: 'ပြသနေသော',
    AppStrings.of: '၏',
    AppStrings.page: 'စာမျက်နှာ',
    AppStrings.searchResultsFor: 'ရှာဖွေရလဒ်များ',
    AppStrings.selectProduct: 'ကုန်ပစ္စည်းရွေးချယ်ပါ',
    AppStrings.addFirstProduct: 'ပထမကုန်ပစ္စည်းထည့်ရန်',
    AppStrings.noProductsFound: 'ကုန်ပစ္စည်းများမရှိပါ',
  };
}