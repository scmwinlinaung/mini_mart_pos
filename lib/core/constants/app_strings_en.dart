...
class AppStringsEn {
  static Map<String, String> get strings => {
    ...
    // Category Management
    AppStrings.categoryManagement: 'Category Management',
    ...
    AppStrings.categoryStatistics: 'Category Statistics',
    AppStrings.totalCategories: 'Total Categories',
    AppStrings.categoriesWithProducts: 'Categories with Products',
    AppStrings.categories: 'Categories',
    AppStrings.searchCategories: 'Search Categories',
    AppStrings.noCategoriesFound: 'No Categories Found',
    AppStrings.addFirstCategory: 'Add Your First Category',
    AppStrings.products: 'Products',
    AppStrings.stock: 'Stock',
    AppStrings.noDescription: 'No Description',
    AppStrings.cannotDelete: 'Cannot Delete',
    AppStrings.deleteCategory: 'Delete Category',
    AppStrings.deleteCategoryConfirmation: 'Are you sure you want to delete this category?',
    AppStrings.editCategory: 'Edit Category',
    AppStrings.addNewCategory: 'Add New Category',

    // Additional strings
    AppStrings.all: 'All',
    AppStrings.inStock: 'In Stock',
    AppStrings.lowStock: 'Low Stock',
    AppStrings.outOfStock: 'Out of Stock',
    AppStrings.newItem: 'New Item',
    AppStrings.addFirstItem: 'Add Your First Item',
    AppStrings.showing: 'Showing',
    AppStrings.of: 'of',
    AppStrings.page: 'Page',
    AppStrings.searchResultsFor: 'Search results for',
    AppStrings.selectProduct: 'Select a product to view details',
    AppStrings.addFirstProduct: 'Add Your First Product',
    AppStrings.noProductsFound: 'No Products Found',
  };
}